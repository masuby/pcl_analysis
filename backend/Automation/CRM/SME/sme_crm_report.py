...
processed_file = fr"C:\Users\Daniel\Desktop\code\pcl\CRM\SME\NEW_EXCEL\CRM_PROCESSED_{timestamp}.xlsx"
...
def copy_sheets_to_master():
    ...
    try:
        ...
        new_master_file = fr"C:\Users\Daniel\Desktop\code\pcl\CRM\SME\NEW_EXCEL\SME_CRM_{MANUAL_DATE.replace('/', '_')}.xlsx"
