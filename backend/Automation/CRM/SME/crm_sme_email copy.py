...
def generate_html_email(crm_email_data, image_paths, excel_file_path):
        ...
        <div class="container">
            ...
            <div class="section">
                ...
                <div class="content">
                    ...
                    <div class="stat-box">
                        <p>Out of <span class="number-value">{generated_lead}</span> leads, <span class="number-value">{prospect_lead}</span> {prospect_lead_phrase}</p>
                    </div>
            ...
            <div class="section">
                ...
                <div class="content">
                    ...
                    <div class="stat-box">
                        <p><span class="number-value">{today_location_planned_display}</span> locations have been planned.</p>
                ...
                <div class="content">
                    ...
                    <div class="highlight">
                        <p><span class="number-value">{tl_no_planned_visited_location_display}</span> had no planned location visited by a TL.</p>
                    </div>
                    
                    <div class="subsection-title">📅 For today {todays_activities_date}</div>
                    <div class="stat-box">
                        <p><span class="number-value">{today_tl_location_planned_display}</span> locations have been planned.</p>
    ...
    prospect_lead_val = get_value('prospect_lead', '0')
    try:
        prospect_n = int(prospect_lead_val) if prospect_lead_val not in (None, '', 'N/A', 'none') else 0
    ...
    tl_no_planned_visited_location_raw = get_value('tl_no_planned_visited_location')
    today_location_planned_raw = get_value('today_location_planned', '0')
    today_tl_location_planned_raw = get_value('today_tl_location_planned', '0')
    ...
    html_content = html_template.format(
        ...
        today_location_planned_display=_display_or_none(today_location_planned_raw),
        ...
        tl_no_planned_visited_location_display=_display_or_none(tl_no_planned_visited_location_raw),
        today_tl_location_planned=get_value('today_tl_location_planned', '0'),
        today_tl_location_planned_display=_display_or_none(today_tl_location_planned_raw),
