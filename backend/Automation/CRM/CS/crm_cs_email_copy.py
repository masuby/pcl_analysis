...
def initialize_config():
    ...
    config = {
        ...
        'receiver_emails': [
            ...
            # 'www.danielclement468@gmail.com',
...
def generate_html_email(crm_email_data, image_paths, excel_file_path):
        ...
        <div class="container">
            ...
            <div class="section">
                ...
                <div class="content">
                    ...
                    <div class="highlight">
                        <p><span class="number-value">{agent_count_without_planned_location_display}</span> branches had no planned location visited by an agent. 
                        ({agent_branch_without_planned_location})</p>
                        <p><span class="number-value">{branches_count_without_assgned_activities_display}</span> branches had no assigned activities or planned locations to be visited 
                ...
                <div class="content">
                    ...
                    <div class="highlight">
                        <p><span class="number-value">{branches_tl_count_no_planned_location_display}</span> branches had no planned location visited by a TL. 
                        ({branches_tl_no_planned_location})</p>
                        <p><span class="number-value">{branches_tl_count_no_assigned_activites_display}</span> branches had not assigned any activities or locations to their TLs. 
    ...
    agent_count_without_planned_location_raw = get_value('agent_count_without_planned_location')
    branches_count_without_assgned_activities_raw = get_value('branches_count_without_assgned_activities')
    branches_tl_count_no_planned_location_raw = get_value('branches_tl_count_no_planned_location')
    branches_tl_count_no_assigned_activites_raw = get_value('branches_tl_count_no_assigned_activites')
    ...
    html_content = html_template.format(
        ...
        agent_count_without_planned_location_display=_display_or_none(agent_count_without_planned_location_raw),
        ...
        branches_count_without_assgned_activities_display=_display_or_none(branches_count_without_assgned_activities_raw),
        ...
        branches_tl_count_no_planned_location_display=_display_or_none(branches_tl_count_no_planned_location_raw),
        ...
        branches_tl_count_no_assigned_activites_display=_display_or_none(branches_tl_count_no_assigned_activites_raw),
