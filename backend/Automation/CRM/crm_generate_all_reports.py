"""crm_generate_all_reports.py — build ALL department CRM reports in one pass.
...
EMAIL_SCRIPTS = {
    "CS":  BASE_DIR / "CS" / "crm_cs_email.py",
    "LBF": BASE_DIR / "LBF" / "crm_lbf_email.py",
    "SME": BASE_DIR / "SME" / "crm_sme_email.py",
}
...
def main():
    ...
    do_emails = args.emails or args.full
    do_update = args.update_master or args.full
