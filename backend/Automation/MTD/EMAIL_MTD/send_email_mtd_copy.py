...
import re
from email_list_copy import get_all_files_with_emails, convert_month_to_swahili
...
def create_beautiful_email_html(subject, current_day=6, current_month=None, current_year=None):
    """
        ...
        <div class="email-container">
            ...
            <div class="content">
                ...
                <div class="message">
                    ...
                    kama kuna marekebisho usisite kuwasilisha kwa <span class="period">CREDIT/COORDINATOR</span> kabla ya <span class="period">SAA 8 MCHANA.</span>
                </div>
...
def main():
    ...
    print("  1. www.danielclement468@gmail.com")
    print("  2. raphael@platinumcredit.co.tz")
    print("\nOther recipients are commented out for development.")
    
    confirm = input("\nDo you want to proceed with sending emails? (yes/no): ").strip().lower()
    ...
    for i, file_info in enumerate(files, 1):
        ...
        if day:
            ...
            current_day = int(day_match.group(1)) if day_match else 6
        ...
        import time
        if i < len(files):  # Don't wait after the last email
            time.sleep(2)
