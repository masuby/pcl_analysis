...
DEFAULT_ZONE_CLUSTER_PATH = os.path.join(SCRIPT_DIR, "Zone and cluster.xlsx")
ENV_FILE_PATH = os.path.join(SCRIPT_DIR, ".env")
OUTPUT_DIR = r"C:\Users\Daniel\Desktop\Management"
...
CRM_NEW_EXCEL_DIR = r"C:\Users\Daniel\Desktop\code\pcl\CRM\CS\NEW_EXCEL"
...
def main() -> None:
    ...
    send_all = input("Send email to all managers? [y/N]: ").strip().lower() in (
        "y",
        "yes",
    )
