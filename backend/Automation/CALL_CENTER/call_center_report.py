...
# Newer PSE-CDR exports use different header names; map to the legacy columns the rest of this script expects.
_col_map = {}
if "Status" not in df.columns and "Last Status" in df.columns:
    _col_map["Last Status"] = "Status"
if "Talk Duration" not in df.columns and "Handling Duration" in df.columns:
    _col_map["Handling Duration"] = "Talk Duration"
if _col_map:
...
# For combined_agents_df - calculate success rate as (Successful Calls / 50) * 100
combined_agents_df['Success Rate (%)'] = (combined_agents_df['Successful Calls'] / 50 * 100)
...
# =============================================================================
# END PROCESS: upload the freshly generated report(s) to the live PCL system.
...
_UPLOAD_SCRIPT = r"C:\Users\Daniel\Desktop\code\pcl\CRM\direct_upload_files_to_db.py"
print("\n" + "=" * 78)
