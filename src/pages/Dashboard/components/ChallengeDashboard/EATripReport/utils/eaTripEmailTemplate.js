/**
 * HTML email template for EA Trip Qualification Report — SALES MANAGERS.
 * @param {Object} summary  — from processEATripReport
...
<head>
  ...
  <title>EA Trip Qualification Report — Sales Managers</title>
</head>
        ...
        <tr>
          <td style="background:linear-gradient(135deg,#1f3864 0%,#2e74b5 100%);padding:32px 40px;text-align:center;">
            <h1 style="margin:0;color:#fff;font-size:26px;font-weight:700;letter-spacing:0.5px;">
              🏆 EAST AFRICA TRIP QUALIFICATION REPORT — SALES MANAGERS
            </h1>
        ...
        <tr>
          <td style="padding:28px 40px 0;">
            ...
            <p style="margin:0 0 18px;font-size:13px;color:#4b5563;line-height:1.7;">
              Please find the <strong>EA Trip Qualification Report — Sales Managers</strong> for the period <strong>${period}</strong>.
              This report evaluates Sales Managers (Branch Managers, Regional Managers, Call Center Supervisors) against the 2026 EA Trip criteria
        ...
        <tr>
          <td style="background:#f8fafc;padding:20px 40px;border-top:1px solid #e5e7eb;text-align:center;">
            <p style="margin:0;color:#9ca3af;font-size:11px;">
              This is an automated report from the PCL Analysis — EA Trip system.
            </p>
          </td>
        </tr>
