/**
 * HTML email template for Local Trip Qualification Report — SALES DEPARTMENTS.
 * @param {Object} summary  — from processLocalTripReport
 * @param {string[]} monthsInData
 * @returns {string} full HTML string
 */
export function buildLocalTripEmailHTML(summary, monthsInData) {
  const {
...
<head>
  ...
  <title>Local Trip Qualification Report — Sales Departments</title>
</head>
        ...
        <tr>
          <td style="background:linear-gradient(135deg,#1f3864 0%,#2e74b5 100%);padding:32px 40px;text-align:center;">
            <h1 style="margin:0;color:#fff;font-size:26px;font-weight:700;letter-spacing:0.5px;">
              🏆 LOCAL TRIP QUALIFICATION REPORT — SALES DEPARTMENTS
            </h1>
        ...
        <tr>
          <td style="padding:28px 40px 0;">
            ...
            <p style="margin:0 0 18px;font-size:13px;color:#4b5563;line-height:1.7;">
              Please find the <strong>Local Trip Qualification Report — Sales Departments</strong> for the period <strong>${period}</strong>.
              This report evaluates Sales Reps, Team Leaders, and Regions against the 2026 Local Trip criteria
        ...
        <tr>
          <td style="background:#f8fafc;padding:20px 40px;border-top:1px solid #e5e7eb;text-align:center;">
            <p style="margin:0;color:#9ca3af;font-size:11px;">
              This is an automated report from the PCL Analysis — Local Trip system.
            </p>
          </td>
        </tr>
