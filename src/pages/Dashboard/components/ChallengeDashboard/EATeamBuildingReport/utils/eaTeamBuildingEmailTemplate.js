/**
 * HTML email template for EA Team Building Report — ALL PCL STAFF (KE & UG).
 * @param {Object} summary  — from processEATeamBuildingReport
...
<head>
  ...
  <title>EA Team Building Report — All PCL Staff (KE & UG)</title>
</head>
        ...
        <tr>
          <td style="background:linear-gradient(135deg,#1f3864 0%,#2e74b5 100%);padding:32px 40px;text-align:center;">
            <h1 style="margin:0;color:#fff;font-size:26px;font-weight:700;letter-spacing:0.5px;">
              🏆 EAST AFRICA TEAM BUILDING REPORT — ALL PCL STAFF (KE & UG)
            </h1>
        ...
        <tr>
          <td style="background:#f8fafc;padding:20px 40px;border-top:1px solid #e5e7eb;text-align:center;">
            <p style="margin:0;color:#9ca3af;font-size:11px;">
              This is an automated report from the PCL Analysis — EA Team Building system.
            </p>
          </td>
        </tr>
