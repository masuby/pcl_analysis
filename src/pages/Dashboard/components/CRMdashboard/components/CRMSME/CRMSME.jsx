...
const CRMSME = () => {
  ...
  const { reports, parsedData, loading, error, hasData } = useCRMData('SME', selectedDate);
  ...
  if (!hasData) {
    return (
      <div className="crm-coming-soon">
        ...
        <h2>CRM Analysis for SME is coming soon</h2>
        <p className="coming-soon-subtext">
          We're working on bringing you comprehensive CRM analytics for the SME department.
          Check back soon!
        </p>
      </div>
    );
