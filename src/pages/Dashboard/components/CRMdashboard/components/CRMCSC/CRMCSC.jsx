...
const CRMCSC = () => {
  ...
  const { reports, parsedData, loading, error, hasData } = useCRMData('CS', selectedDate);
  ...
  if (!hasData) {
    return (
      <div className="crm-coming-soon">
        ...
        <h2>CRM Analysis for CS is coming soon</h2>
        <p className="coming-soon-subtext">
          We're working on bringing you comprehensive CRM analytics for the CS department.
          Check back soon!
        </p>
      </div>
    );
