// C:\Users\Daniel\Desktop\code\Website\pcl_analysis\src\pages\Dashboard\components\ManagementDashboard\components\CSZANZIBARSection\CSZANZIBARSection.jsx
import { useState, useEffect } from 'react';
import './CSZANZIBARSection.css';
import CSZANZIBARChart from './CSZANZIBARChart';
import CSZANZIBARAnalysis from './CSZANZIBARAnalysis';
import { getNumericColumns } from '../../utils/reportUtils';

const defaultFromDate = new Date(new Date().getFullYear(), new Date().getMonth(), 1);

const CSZANZIBARSection = ({ data }) => {
  ...
  return (
    <div className="section-card">
      <div className="section-header">
        <h3 className="section-title">🏝️ CS ZANZIBAR (ZANZIBAR branch) Analysis</h3>
      ...
      <div className="section-content">
        <div className="section-container">
          ...
          <CSZANZIBARAnalysis data={chartData} metric={column} fromDate={appliedFrom} toDate={appliedTo} />
        </div>
      </div>
    </div>
  );
...
export default CSZANZIBARSection;
