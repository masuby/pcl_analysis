// C:\Users\Daniel\Desktop\code\Website\pcl_analysis\src\pages\Dashboard\components\ManagementDashboard\components\SMESection\SMEAnalysis.jsx
import { analyzeData } from '../../utils/analysisUtils';
import '../CountrywiseSection/CountrywiseSection.css';

const SMEAnalysis = ({ data, metric, fromDate, toDate }) => {
