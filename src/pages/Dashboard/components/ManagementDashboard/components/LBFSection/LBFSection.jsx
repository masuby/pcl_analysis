// C:\Users\Daniel\Desktop\code\Website\pcl_analysis\src\pages\Dashboard\components\ManagementDashboard\components\LBFSection\LBFSection.jsx
import { useState, useEffect } from 'react';
import './LBFSection.css';
import LBFChart from './LBFChart';
import LBFAnalysis from './LBFAnalysis';
import { getNumericColumns } from '../../utils/reportUtils';

const defaultFromDate = new Date(new Date().getFullYear(), new Date().getMonth(), 1);

const LBFSection = ({ data, branchesData = {} }) => {
    ...
    <div className="section-card">
      ...
      <div className="section-content">
        <div className="section-container">
          ...
          <LBFAnalysis data={chartData} metric={column} fromDate={appliedFrom} toDate={appliedTo} />
        </div>
      </div>
    </div>
  );
