...
import './SMECallCenter.css';

const SMECallCenter = () => {
  const [selectedDate, setSelectedDate] = useState(null);
  const { reports, parsedData, loading, error, hasData } = useCallCenterData('SME', selectedDate);
  ...
  if (!hasData) {
    return (
      <div className="call-center-coming-soon">
        ...
        <h2>Call Center Analysis for SME is coming soon</h2>
        <p className="coming-soon-subtext">
          We're working on bringing you comprehensive call center analytics for the SME department.
          Check back soon!
        </p>
      </div>
    );
