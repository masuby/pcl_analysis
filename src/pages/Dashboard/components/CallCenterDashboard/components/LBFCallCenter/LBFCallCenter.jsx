...
import './LBFCallCenter.css';

const LBFCallCenter = () => {
  const [selectedDate, setSelectedDate] = useState(null);
  const { reports, parsedData, loading, error, hasData } = useCallCenterData('LBF', selectedDate);
  ...
  if (!hasData) {
    return (
      <div className="call-center-coming-soon">
        ...
        <h2>Call Center Analysis for LBF is coming soon</h2>
        <p className="coming-soon-subtext">
          We're working on bringing you comprehensive call center analytics for the LBF department.
          Check back soon!
        </p>
      </div>
    );
